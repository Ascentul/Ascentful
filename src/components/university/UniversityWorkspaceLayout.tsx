...
/**
 * UniversityWorkspaceLayout
 *
 * Layout wrapper for the unified /u/* workspace.
 * Renders the university workspace sidebar and main content area.
 * Follows the same patterns as the main Layout component.
 */
  ...
  return (
    <>
      ...
      <div className="md:hidden">
        <UniversityWorkspaceSidebar isOpen={mobileSidebarOpen} onToggle={toggleMobileSidebar} />
      </div>
...
export function UniversityWorkspaceLayout({ children }: UniversityWorkspaceLayoutProps) {
...
export default UniversityWorkspaceLayout;
