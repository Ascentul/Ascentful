...
export const PreferencesSection = forwardRef<PreferencesSectionRef, Record<string, never>>(
  (_, ref) => {
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-slate-500">
                For on-site or hybrid positions, enter all cities in which you are open to working
                at.
              </p>
              <div className="flex gap-2">
                <Input
